...
func (self *CmakeConverter) writeCommonHeaderTop(packageName core.PackageName, w io.Writer) error {
...
func (self *CmakeConverter) writeCommonIncludes(packageName core.PackageName, w io.Writer) error {
